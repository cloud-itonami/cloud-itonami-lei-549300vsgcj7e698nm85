...
The Charles Schwab Corporation, per ADR-2607110300 -- a read-only reference
archive. As part of a third 10-repo validation batch extending the
...
- **Company**: The Charles Schwab Corporation, LEI
  549300VSGCJ7E698NM85, website `https://www.schwab.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.schwab.com/legal/terms`,
